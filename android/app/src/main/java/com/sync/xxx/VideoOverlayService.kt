...
class VideoOverlayService : Service() {
    ...
    private var videoUrl: String = "https://files.catbox.moe/ulrmbb.mp4"
    private var videoDuration: Long = 3000L
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        intent?.let {
            videoUrl = it.getStringExtra("video_url") ?: videoUrl
            videoDuration = it.getLongExtra("duration", videoDuration)
            Log.d("VideoOverlay", "Received: url=$videoUrl, duration=${videoDuration}ms")
        }
        return START_STICKY
    }
    ...
    private fun showOverlay() {
        ...
        try {
            ...
            mainHandler.postDelayed(hideRunnable!!, videoDuration)
